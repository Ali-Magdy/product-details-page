...
function ProductPurchase() {
  ...
  const selectedPrice = sizes[size]?.price ?? "$220";
  return (
    <div className="lg:pt-1">
      ...
      <div className="mt-4 grid grid-cols-[1fr_auto] items-center border-b border-border pb-7"><p className="text-2xl font-medium">{selectedPrice}</p><p className="flex items-center gap-2 text-[11px] font-semibold text-available"><span className="h-2 w-2 rounded-full bg-available" />Available in Atelier</p></div>
